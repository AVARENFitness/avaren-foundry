-- AVAREN Sprint 8.3.12 — Athlete appointment coach_id for follow-up identity
-- DO NOT RUN AUTOMATICALLY — execute in Supabase SQL Editor.
--
-- Fixes live followup_insert_invalid_scheduled_session when follow-up insert
-- used coach_clients.limit(1) instead of the appointment's coach_id.
--
