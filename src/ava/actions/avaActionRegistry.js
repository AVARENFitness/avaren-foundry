...
export const AVA_ACTION_REGISTRY = {
  ...
  [AVA_ACTION_IDS.SHOW_TODAY_APPOINTMENTS]: {
    id: AVA_ACTION_IDS.SHOW_TODAY_APPOINTMENTS,
    domain: AVA_ACTION_DOMAINS.COACH,
    description: 'Show today in-person appointments.',
    requiredContext: [],
    confirmationPolicy: AVA_ACTION_CONFIRMATION.NONE,
    reversible: false,
    allowedRoles: ['coach'],
    buildSuccessMessage: () => "Here is today's in-person schedule.",
    buildFailureMessage: () => "I couldn't load today's appointments.",
  },
  [AVA_ACTION_IDS.OPEN_TODAY_SCHEDULE]: {
    id: AVA_ACTION_IDS.OPEN_TODAY_SCHEDULE,
    domain: AVA_ACTION_DOMAINS.COACH,
    description: 'Open coach calendar schedule.',
    requiredContext: [],
    confirmationPolicy: AVA_ACTION_CONFIRMATION.NONE,
    reversible: false,
    allowedRoles: ['coach'],
    buildSuccessMessage: () => 'Opening your schedule.',
    buildFailureMessage: () => "I couldn't open your schedule.",
  },
