...
export const normalizeScheduledSession = (row) => {
  ...
  return {
    ...
    businessClientId: row.business_client_id ?? null,
    missedChargeDecision: row.missed_charge_decision ?? null,
    missedChargeDecidedAt: row.missed_charge_decided_at ?? null,
